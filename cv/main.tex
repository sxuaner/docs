...
{\sl Client-side Technologien:} 	Javascript\\
{\sl Server-side Technologien:} 	MySQL, Linux OS, Apache Tomcat Web Server, Java Servlet, Jenkins, PHP\\
{\sl Andere Technologien:}  		JUnit Test Framework, Git, Latex, Gradle
...
{\sl Client-side Technologies:} 	Javascript\\
{\sl Server-side Technologies:} 	MySQL, Linux OS, Apache Tomcat Web Server, Java Servlet, Jenkins\\
{\sl Other Technologies:}  		JUnit Test Framework, Git, Latex, Gradle
