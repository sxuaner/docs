...
{\sl Programming Languages:}\hfill		Java, Javascript, PHP, HTML\\
{\sl Object-oriented Design:}\hfill 		Design Patterns\\
{\sl Web Development relevant:}\hfill 	Java Servlet, Node.js, XML, JSON, Tomcat\\
...
{\sl SW Development Process}\hfill 		Scrum, Continuous Integration(Jenkins)\\
...
{\sl Programming Languages}		Java, Javascript, PHP, HTML\\
{\sl Object-oriented Design} 		Design Patterns\\
{\sl Web Development relevant}		Java Servlet, Node.js, XML, JSON, Tomcat\\
{\sl Database} 						ER Model, RDBMS(Mysql)    
{\sl Frameworks}  					JUnit, Spring\\
{\sl Version Control \& Build}		Git, Gradle, Maven\\
{\sl Modeling Language}				UML
{\sl SW Development Process}		Scrum, Continuous Integration(Jenkins)\\
{\sl IDE \& OS} 					Windows, Linux, Eclipse
